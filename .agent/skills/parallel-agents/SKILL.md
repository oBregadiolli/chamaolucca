...
| Need | Skill |
| :--- | :--- |
| Theoretical architectures (Supervisor, Hierarchical) | `multi-agent-orchestration` |
| Agent reasoning patterns | `agentic-patterns` |
| Tool construction for agents | `tool-construction` |
| Task planning methodology | `plan-writing` |
